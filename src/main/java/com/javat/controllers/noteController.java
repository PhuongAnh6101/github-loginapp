...
public String edit(ModelMap note,@PathVariable(name="title") String title,ModelMap model, HttpSession session) {
	if (session.getAttribute("USERNAME") !=null) {
...
public String delete(ModelMap note,@PathVariable(name="title") String title,ModelMap model, HttpSession session) {
	if (session.getAttribute("USERNAME") !=null) {
...
@RequestMapping("/find")
public String find(ModelMap note,@RequestParam(defaultValue ="") String title,ModelMap model, HttpSession session) {
	if (session.getAttribute("USERNAME") !=null) {
